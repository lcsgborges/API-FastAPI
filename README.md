...
É uma prática de desenvolvimento que envolve a integração regular do código-fonte ao repositório principal, acompanhada de testes automatizados para garantir a qualidade.

### GitHub Actions

É um serviço do GitHub que automatiza workflows dentro do repositório. Podemos configurar o GitHub Actions para executar ações específicas - como testes automatizados - cada vez que um novo código é commitado no repositório.

> Pipeline: sequências de passos (workflow)

Sequência do nosso workflow:

- git push
- iniciar o ubuntu (padrão do GitHub Actions)
- configurar as variáveis de ambiente
- instalar a versão 3.13 do python
- copiar os arquivos do repositório para o ambiente
- instalar o poetry
- instalar as dependências com o poetry
- executar os testes com o poetry
